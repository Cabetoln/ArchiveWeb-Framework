...
const STORAGE_PRICES = 'archive_games_last_prices'
const STORAGE_NOTIFS = 'archive_games_notifications'
const STORAGE_TRIGGERED_ALERTS = 'archive_games_triggered_alerts'
