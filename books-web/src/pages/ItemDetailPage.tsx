    ...
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
        ...
        <div className="flex flex-col">
          <p className="text-xs tracking-widest text-muted uppercase mb-3">{item.attributes?.author}</p>
          <h1 className="font-display text-4xl lg:text-5xl tracking-wide text-cream leading-tight mb-2">
            {item.name.toUpperCase()}
          </h1>
          {item.attributes?.genre && (
            <p className="text-xs tracking-widest text-muted uppercase mb-8">{item.attributes.genre}</p>
          )}
